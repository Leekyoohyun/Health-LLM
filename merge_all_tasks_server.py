#!/usr/bin/env python3
"""
서버용: Health-LLM/ 디렉토리 내의 8개 task 데이터를 병합하여 finetune_data.json 생성
"""
import json
import os

# 8개 task 파일 (현재 디렉토리에 있음)
files = [
    "PMData_stress_train_all.json",
    "PMData_readiness_train_all.json",
    "PMData_sleep_quality_train_all.json",
    "PMData_fatigue_train_all.json",
    "LifeSnaps_stress_resilience_train_all.json",
    "LifeSnaps_sleep_disorder_train_all.json",
    "AW_FB_activity_train_all.json",
    "AW_FB_calories_train_all.json",
]
