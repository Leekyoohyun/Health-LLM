#!/bin/bash
# finetune_full.sh - Full Fine-tuning 실험 (OOM 테스트)
# 목적: OOM 발생 지점 확인 및 Peak GPU Memory 측정
# 예상 결과: OOM 발생 (24GB GPU 메모리 초과)
#
# 실행: bash scripts/finetune_full.sh

set -e

echo "=========================================="
echo "  실험 1: Full Fine-tuning (OOM 테스트)"
echo "=========================================="
echo ""
echo "목적: OOM 발생 지점 확인, Peak GPU Memory 측정"
echo "예상: CUDA out of memory 에러 발생"
echo ""
...
echo ""
echo "다음 단계: bash scripts/finetune_lora.sh"
