#!/usr/bin/env python3
"""
Baseline (MedAlpaca-7b) Validation Set 평가 - 개선된 프롬프트
학습 시 남겨둔 10% validation set만 평가
각 task 끝날 때마다 저장 (중간 체크 가능)

개선사항:
- 프롬프트에 "숫자만 출력" 강제 추가
- repetition_penalty=1.1 유지
"""
...
OUTPUT_FILE = "baseline_improved_results.json"
...
# ========================================
# Inferer 로드 (Baseline only, no LoRA)
# ========================================
print("=" * 80)
...
print("✓ Baseline model loaded (no LoRA adapter)\n")

# ========================================
# Validation Set 평가 (각 task별 10%)
# ========================================
print("=" * 80)
print("BASELINE VALIDATION SET EVALUATION (IMPROVED PROMPT)")
...
# ========================================
print("\n" + "=" * 80)
print("BASELINE (IMPROVED) EVALUATION COMPLETE")
print("=" * 80)
...
print()
print("  2. Compare with fine-tuned results:")
