#!/usr/bin/env python3
"""
Fine-tuned HealthAlpaca-7b Validation Set 평가 (CLEAN)
Baseline은 포기하고 Fine-tuned만 제대로 평가
"""
...
OUTPUT_FILE = "finetuned_clean_results.json"
...
# ========================================
# Fine-tuned Inferer 로드
# ========================================
print("=" * 80)
print("Loading Fine-tuned HealthAlpaca-7b (MedAlpaca-7b + LoRA)")
print("=" * 80)
...
# ========================================
print("=" * 80)
print("FINE-TUNED VALIDATION SET EVALUATION")
...
# ========================================
print("\n🎯 Next steps:")
print("  1. Calculate MAE/Accuracy:")
print(f"     python calculate_baseline_mae.py --input {OUTPUT_FILE}")
print()
print("  2. Compare with paper Table 3 (Fine-tuned column)")
print()
print("  3. If needed, continue evaluation:")
print("     python evaluate_finetuned_clean.py")
print("=" * 80)
