#!/usr/bin/env python3
"""
Fine-tuned LoRA 모델 테스트 - 짧은 답변 강제
max_new_tokens를 줄여서 간결한 출력 유도
"""
...
# ========================================
print("=" * 80)
print("QUICK TEST: Fine-tuned Model (SHORT OUTPUT)")
print("=" * 80)
...
for task_idx, task in enumerate(TASKS):
    ...
    try:
        ...
        # Inference - 짧은 답변 강제
        print(f"\n⏳ Generating (max_new_tokens=64)...")
        answer = inferer(
            instruction=instruction,
            input=input_text,
            max_new_tokens=64,  # 256 → 64 (짧게)
...
print("=" * 80)
print("\n💡 Shorter outputs (max_new_tokens=64) should reduce AI refusal")
print("=" * 80)
