#!/usr/bin/env python3
"""
Fine-tuned (MedAlpaca-7b + LoRA) Validation Set 평가
...
# ========================================
print("=" * 80)
print("FINE-TUNED VALIDATION SET EVALUATION (IMPROVED PROMPT)")
...
print("     python calculate_baseline_mae.py --input baseline_improved_results.json")
print("=" * 80)
